<div class="wrapper container-fluid">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-offset-2 col-xs-10">
            {!! Html::image('assets/img/'.$data['images'],'',['class'=>'img-responsive','width'=>'150px','height'=>'150px']) !!}
    ...
    <div class="form-group">
        ...
        <div class="col-xs-8">
            {!! Form::file('images',['class'=>'filestyle','data-placeholder'=>'Файл не выбран','data-text'=>'Выберите изображение','data-btnClass'=>'btn-primary'])!!}
        </div>
    </div>
    <div class="form-group">
        <div class="col-xs-offset-2 col-xs-10">
